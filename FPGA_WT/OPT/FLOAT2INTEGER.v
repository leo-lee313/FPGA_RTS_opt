...
module  FLOAT2INTEGER_altbarrel_shift_qsf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FLOAT2INTEGER_altbarrel_shift_qsf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 189 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FLOAT2INTEGER_altfp_convert_o0o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	FLOAT2INTEGER_altbarrel_shift_qsf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //FLOAT2INTEGER_altfp_convert_o0o
//VALID FILE
...
module FLOAT2INTEGER (
	...
	FLOAT2INTEGER_altfp_convert_o0o	FLOAT2INTEGER_altfp_convert_o0o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
