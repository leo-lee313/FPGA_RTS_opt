...
//lpm_mux DEVICE_FAMILY="Stratix V" LPM_PIPELINE=1 LPM_SIZE=13 LPM_WIDTH=1 LPM_WIDTHS=4 clock data result sel
...
module muxer12_math (
	...
	muxer12_math_mux	muxer12_math_mux_component (
				.clock (clock),
				.data (sub_wire3),
				.sel (sel),
				.result (sub_wire0));
