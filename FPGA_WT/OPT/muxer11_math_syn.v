...
//lpm_mux DEVICE_FAMILY="Stratix V" LPM_PIPELINE=1 LPM_SIZE=12 LPM_WIDTH=1 LPM_WIDTHS=4 clock data result sel
...
module muxer11_math (
	...
	muxer11_math_mux	muxer11_math_mux_component (
				.clock (clock),
				.data (sub_wire3),
				.sel (sel),
				.result (sub_wire0));
