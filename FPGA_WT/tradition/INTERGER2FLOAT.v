...
module  INTERGER2FLOAT_altbarrel_shift_lsf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //INTERGER2FLOAT_altbarrel_shift_lsf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTERGER2FLOAT_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //INTERGER2FLOAT_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTERGER2FLOAT_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //INTERGER2FLOAT_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTERGER2FLOAT_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	INTERGER2FLOAT_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	INTERGER2FLOAT_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //INTERGER2FLOAT_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTERGER2FLOAT_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	INTERGER2FLOAT_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	INTERGER2FLOAT_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //INTERGER2FLOAT_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTERGER2FLOAT_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	INTERGER2FLOAT_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	INTERGER2FLOAT_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
endmodule //INTERGER2FLOAT_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTERGER2FLOAT_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	INTERGER2FLOAT_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	INTERGER2FLOAT_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //INTERGER2FLOAT_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTERGER2FLOAT_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	INTERGER2FLOAT_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	INTERGER2FLOAT_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
endmodule //INTERGER2FLOAT_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 131 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTERGER2FLOAT_altfp_convert_o0o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	INTERGER2FLOAT_altbarrel_shift_lsf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	INTERGER2FLOAT_altpriority_encoder_rb6   altpriority_encoder2
	( 
...
endmodule //INTERGER2FLOAT_altfp_convert_o0o
//VALID FILE
...
module INTERGER2FLOAT (
	...
	INTERGER2FLOAT_altfp_convert_o0o	INTERGER2FLOAT_altfp_convert_o0o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
