...
[ADDtype1, ADDwhere1, ADDtype2, ADDwhere2, ADDsign] = textread('ADD.txt' , '%s%s%s%s%s');
[MULtype1, MULwhere1, MULtype2, MULwhere2] = textread('MUL.txt' , '%s%s%s%s');
[DIVtype1, DIVwhere1, DIVtype2, DIVwhere2] = textread('DIV.txt' , '%s%s%s%s');
[SINtype1, SINwhere1,SINtype2, SINwhere2,SINtype3, SINwhere3] = textread('SIN.txt' , '%s%s%s%s%s%s');
[COStype1, COSwhere1,COStype2, COSwhere2,COStype3, COSwhere3] = textread('COS.txt' , '%s%s%s%s%s%s');
[COMPAREtype1, COMPAREwhere1, COMPAREtype2, COMPAREwhere2] = textread('COMPARE.txt' , '%s%s%s%s');
[LIMITtype1, LIMITwhere1, LIMITtype2, LIMITwhere2, LIMITtype3, LIMITwhere3] = textread('LIMIT.txt' , '%s%s%s%s%s%s');
[EXPtype1, EXPwhere1] = textread('EXP.txt' , '%s%s');
[LOGtype1, LOGwhere1, LOGwhere2, LOGtime] = textread('LOG.txt' , '%s%s%s%s');
...
m=500*W1(1,1)+100*W2(1,1)+1000*W3(1,1)+2000*W4(1,1)+2000*W5(1,1)+W6(1,1)+W7(1,1)+2000*W8(1,1)+50*zbr;   
objective = m;
