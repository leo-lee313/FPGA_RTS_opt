file_name = 'C11WT.txt';
file_name1 = 'C12WT.txt';
file_name2 = 'C13WT.txt';
file_name3 = 'C53WT.txt';
file_name4 = 'C14WT.txt';
file_name5 = 'C15WT.txt';
file_name6 = 'C16WT.txt';
file_name7 = 'C17WT.txt';
file_name8 = 'C18WT.txt';
file_name9 = 'C19WT.txt';
file_name10 = 'C20WT.txt';
...
[PARAMETERNAME, PARAMETERNUM] = textread('PARAMETERWT.txt' , '%s%s');
[HISTORYNAME, HISTORYLEI,HISTORYWHERE] = textread('HISTORYWT.txt' , '%s%s%s');
[INPUTNAME] = textread('INPUTWT.txt' , '%s');
PWMNUM=1;
    ...
    for ilie=1:SHULIANG(lei)
        ...
        for jj=1:cssi(lei,ilie)
             ...
             if str2double(ZONE1{jj,3,ilie,lei})==3
                 for hist =1:length(HISTORYNAME)
                     if strcmp(ZONE1{jj,4,ilie,lei},HISTORYNAME{hist,1})
                         %if histsign(hist) == 0
							 ...
							 if str2double(HISTORYLEI{hist,1})==1||str2double(HISTORYLEI{hist,1})==2||str2double(HISTORYLEI{hist,1})==5||str2double(HISTORYLEI{hist,1})==6||str2double(HISTORYLEI{hist,1})==7||str2double(HISTORYLEI{hist,1})==10
                                 for i = 1:NSHULIANG(str2double(HISTORYLEI{hist,1}))
                                     if str2double(HISTORYWHERE{hist,1})==ZONE2{i,2,str2double(HISTORYLEI{hist,1})}
                                         ...
                                         if  yanshi>=-20
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40;\n']);
                                             fprintf(file6,['System_FIFO_64_1  DELAY_NCLK_','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40(','\n']);
                                             fprintf(file6,['						               .clk(clk),','\n']);
                                             fprintf(file6,['											.rst(rst),','\n']);
                                             fprintf(file6,['											.rst_user(rst_user),','\n']);
                                             fprintf(file6,['											.before_enaread(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 4+40),']),\n']);
                                             ...
                                             fprintf(file6,['						               .cout(','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40)','\n']);
                                             fprintf(file6,['					                 );','\n']);
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                             fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                                                fprintf(file6,['						               .clk(clk),','\n']);
                                                fprintf(file6,['											.rst(rst),','\n']);
                                                fprintf(file6,['											.rst_user(rst_user),','\n']);
                                                fprintf(file6,['											.before_enaread(sta_sig[',num2str(ZONE1{jj,1,ilie,lei}-4),']),\n']);
                                                fprintf(file6,['											.before_enawrite(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 2+40),']),\n']);
                                                fprintf(file6,['								.cin( ','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40',' ),\n']);
                                                fprintf(file6,['								.cout( ','',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' )\n']);
                                                fprintf(file6,['					                 );','\n']);
                                         else
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                            fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                             ...
                             if str2double(HISTORYLEI{hist,1})==9
                                 for i = 1:NSHULIANG(str2double(HISTORYLEI{hist,1}))
                                     if str2double(HISTORYWHERE{hist,1})==ZONE2{i,2,str2double(HISTORYLEI{hist,1})}
                                         yanshi = ZONE1{jj,1,ilie,lei} - ZONE2{i,1,str2double(HISTORYLEI{hist,1})} - DD(str2double(HISTORYLEI{hist,1}));
                                         if  yanshi>=-20
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ','limit_',HISTORYWHERE{hist,1},'_lyf_40;\n']);
                                             fprintf(file6,['System_FIFO_64_1  DELAY_NCLK_','','limit_',HISTORYWHERE{hist,1},'_lyf_40(','\n']);
                                             fprintf(file6,['						               .clk(clk),','\n']);
                                             fprintf(file6,['											.rst(rst),','\n']);
                                             fprintf(file6,['											.rst_user(rst_user),','\n']);
                                             fprintf(file6,['											.before_enaread(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 4+40),']),\n']);
                                             fprintf(file6,['											.before_enawrite(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 2),']),\n']);
                                             fprintf(file6,['						               .cin(','','limit_',HISTORYWHERE{hist,1},'_lyf','),','\n']);
                                             fprintf(file6,['						               .cout(','','limit_',HISTORYWHERE{hist,1},'_lyf_40)','\n']);
                                             fprintf(file6,['					                 );','\n']);
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                             fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                                                fprintf(file6,['						               .clk(clk),','\n']);
                                                ...
                                                fprintf(file6,['											.before_enaread(sta_sig[',num2str(ZONE1{jj,1,ilie,lei}-4),']),\n']);
                                                fprintf(file6,['											.before_enawrite(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 2+40),']),\n']);
                                                fprintf(file6,['								.cin( ','','limit_',HISTORYWHERE{hist,1},'_lyf_40',' ),\n']);
                                                fprintf(file6,['								.cout( ','',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' )\n']);
                                                fprintf(file6,['					                 );','\n']);
                                         else
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                 ...
                 fprintf(file,['															  .value_',num2str(jj),'(',ZONE1{jj,4,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),'),','\n']);
             end
            ...
            for jj=1:cssi(lei,ilie)
             ...
             if str2double(ZONE1{jj,5,ilie,lei})==0
              ...
              if str2double(ZONE1{jj,5,ilie,lei})==3
                                 ...
                                 for i = 1:NSHULIANG(str2double(HISTORYLEI{hist,1}))
                                     if str2double(HISTORYWHERE{hist,1})==ZONE2{i,2,str2double(HISTORYLEI{hist,1})}
                                         ...
                                         if  yanshi>=-20
                                             ...
                                             fprintf(file6,['						               .cout(','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40)','\n']);
                                             fprintf(file6,['					                 );','\n']);
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE1{jj,6,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                             fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE1{jj,6,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                                                fprintf(file6,['						               .clk(clk),','\n']);
                                                fprintf(file6,['											.rst(rst),','\n']);
                                                fprintf(file6,['											.rst_user(rst_user),','\n']);
                                                fprintf(file6,['											.before_enaread(sta_sig[',num2str(ZONE1{jj,1,ilie,lei}-4),']),\n']);
                                                fprintf(file6,['											.before_enawrite(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 2+40),']),\n']);
                                                fprintf(file6,['								.cin( ','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40',' ),\n']);
                                                fprintf(file6,['								.cout( ','',ZONE1{jj,6,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' )\n']);
                                                fprintf(file6,['					                 );','\n']);
                                         else
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE1{jj,6,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                            fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE1{jj,6,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                 ...
                 fprintf(file,['															  .value_',num2str(jj),'(',ZONE1{jj,6,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),'),','\n']);
             end
            ...
            for jj=1:cssi(lei,ilie)
             ...
             if str2double(ZONE1{jj,7,ilie,lei})==0
              ...
              if str2double(ZONE1{jj,7,ilie,lei})==3
                                 ...
                                 for i = 1:NSHULIANG(str2double(HISTORYLEI{hist,1}))
                                     if str2double(HISTORYWHERE{hist,1})==ZONE2{i,2,str2double(HISTORYLEI{hist,1})}
                                         ...
                                         if  yanshi>=-20
                                             ...
                                             fprintf(file6,['						               .cout(','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40)','\n']);
                                             fprintf(file6,['					                 );','\n']);
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE1{jj,8,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                             fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE1{jj,8,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                                                fprintf(file6,['						               .clk(clk),','\n']);
                                                fprintf(file6,['											.rst(rst),','\n']);
                                                fprintf(file6,['											.rst_user(rst_user),','\n']);
                                                fprintf(file6,['											.before_enaread(sta_sig[',num2str(ZONE1{jj,1,ilie,lei}-4),']),\n']);
                                                fprintf(file6,['											.before_enawrite(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 2+40),']),\n']);
                                                fprintf(file6,['								.cin( ','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40',' ),\n']);
                                                fprintf(file6,['								.cout( ','',ZONE1{jj,8,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' )\n']);
                                                fprintf(file6,['					                 );','\n']);
                                         else
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE1{jj,8,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                            fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE1{jj,8,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                 ...
                 fprintf(file,['															  .value_',num2str(jj),'(',ZONE1{jj,8,ilie,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),'),','\n']);
             end
...
for lei=1:length(LEIXING)
    ...
    if lei == 8
        for ilie=1:NSHULIANG(lei)
            fprintf(file9,['reg [`EXTENDED_SINGLE - 1:0] ','compare_',num2str(ZONE2{ilie,2,lei}),'_reg',';\n']);
            fprintf(file9,['wire ','compareone_',num2str(ZONE2{ilie,2,lei}),'_lyf',';\n']);
            fprintf(file9,['wire [`EXTENDED_SINGLE - 1:0] ','compare_',num2str(ZONE2{ilie,2,lei}),'_lyf',';\n']);
            fprintf(file7,['Comparator_64 Comparator_',num2str(ZONE2{ilie,2,lei}),'(\n']);
             ...
             if str2double(ZONE2{ilie,3,lei})==3
                                 ...
                                 for i = 1:NSHULIANG(str2double(HISTORYLEI{hist,1}))
                                     if str2double(HISTORYWHERE{hist,1})==ZONE2{i,2,str2double(HISTORYLEI{hist,1})}
                                         ...
                                         if  yanshi>=-20
                                             ...
                                             fprintf(file6,['						               .cout(','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40)','\n']);
                                             fprintf(file6,['					                 );','\n']);
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE2{ilie,4,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                             fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE2{ilie,4,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                                                fprintf(file6,['						               .clk(clk),','\n']);
                                                fprintf(file6,['											.rst(rst),','\n']);
                                                fprintf(file6,['											.rst_user(rst_user),','\n']);
                                                ...
                                                fprintf(file6,['											.before_enawrite(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 2+40),']),\n']);
                                                fprintf(file6,['								.cin( ','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40',' ),\n']);
                                                fprintf(file6,['								.cout( ','',ZONE2{ilie,4,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' )\n']);
                                                fprintf(file6,['					                 );','\n']);
                                         else
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE2{ilie,4,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                            fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE2{ilie,4,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                 ...
                 fprintf(file7,['								 .input_1(',ZONE2{ilie,4,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),'),','\n']);
             end
             ...
             if str2double(ZONE2{ilie,5,lei})==3
                                 ...
                                 for i = 1:NSHULIANG(str2double(HISTORYLEI{hist,1}))
                                     if str2double(HISTORYWHERE{hist,1})==ZONE2{i,2,str2double(HISTORYLEI{hist,1})}
                                         ...
                                         if  yanshi>=-20
                                             ...
                                             fprintf(file6,['						               .cout(','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40)','\n']);
                                             fprintf(file6,['					                 );','\n']);
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE2{ilie,6,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                             fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE2{ilie,6,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                                                fprintf(file6,['						               .clk(clk),','\n']);
                                                fprintf(file6,['											.rst(rst),','\n']);
                                                fprintf(file6,['											.rst_user(rst_user),','\n']);
                                                fprintf(file6,['											.before_enaread(sta_sig[',num2str(ZONE2{ilie,1,lei}-4),']),\n']);
                                                fprintf(file6,['											.before_enawrite(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 2+40),']),\n']);
                                                fprintf(file6,['								.cin( ','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40',' ),\n']);
                                                fprintf(file6,['								.cout( ','',ZONE2{ilie,6,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' )\n']);
                                                fprintf(file6,['					                 );','\n']);
                                         else
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE2{ilie,6,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                            fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE2{ilie,6,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                 ...
                 fprintf(file7,['								 .input_2(',ZONE2{ilie,6,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),'),','\n']);
             end
            ...
            fprintf(file7,['								 .output_1','(compareone_',num2str(ZONE2{ilie,2,lei}),'_lyf',')','\n']);
            fprintf(file7,['							   );','\n']);
            fprintf(file7,['always@(posedge clk or posedge rst) begin','\n']);
            fprintf(file7,['	if(rst) begin','\n']);
            fprintf(file7,['		compare_',num2str(ZONE2{ilie,2,lei}),'_reg <= 64''h0000000000000000;','\n']);
            fprintf(file7,['	end','\n']);
            fprintf(file7,['	else if(compareone_',num2str(ZONE2{ilie,2,lei}),'_lyf) begin','\n']);
            fprintf(file7,['		compare_',num2str(ZONE2{ilie,2,lei}),'_reg <= 64''h3FF0000000000000;','\n']);
            fprintf(file7,['	end','\n']);
            fprintf(file7,['	else if(!compareone_',num2str(ZONE2{ilie,2,lei}),'_lyf) begin','\n']);
            fprintf(file7,['		compare_',num2str(ZONE2{ilie,2,lei}),'_reg <= 64''h0000000000000000;','\n']);
            fprintf(file7,['	end','\n']);
            fprintf(file7,['end','\n']);
            fprintf(file7,['assign compare_',num2str(ZONE2{ilie,2,lei}),'_lyf = compare_',num2str(ZONE2{ilie,2,lei}),'_reg;','\n']);
        end
    end
    if lei == 9
        for ilie=1:NSHULIANG(lei)
            fprintf(file9,['wire [`EXTENDED_SINGLE - 1:0] ','limit_',num2str(ZONE2{ilie,2,lei}),'_lyf',';\n']);
            fprintf(file8,['limit_control_system64_water limit_',num2str(ZONE2{ilie,2,lei}),'(\n']);
             ...
             if str2double(ZONE2{ilie,3,lei})==3
                 ...
                 fprintf(file8,['									  .upper_limit(',ZONE2{ilie,4,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),'),','\n']);
             end
             if str2double(ZONE2{ilie,3,lei})==4
                 for inpu =1:length(INPUTNAME)
                     if strcmp(ZONE2{ilie,4,lei},INPUTNAME{inpu,1})
             ...
             if str2double(ZONE2{ilie,5,lei})==3
                 ...
                 fprintf(file8,['									  .down_limit(',ZONE2{ilie,6,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),'),','\n']);
             end
             if str2double(ZONE2{ilie,5,lei})==4
                 for inpu =1:length(INPUTNAME)
                     if strcmp(ZONE2{ilie,6,lei},INPUTNAME{inpu,1})
			...
			if str2double(ZONE2{ilie,7,lei})==0
             ...
             if str2double(ZONE2{ilie,7,lei})==3
                                 ...
                                 for i = 1:NSHULIANG(str2double(HISTORYLEI{hist,1}))
                                     if str2double(HISTORYWHERE{hist,1})==ZONE2{i,2,str2double(HISTORYLEI{hist,1})}
                                         ...
                                         if  yanshi>=-20
                                             ...
                                             fprintf(file6,['						               .cout(','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40)','\n']);
                                             fprintf(file6,['					                 );','\n']);
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE2{ilie,8,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                             fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE2{ilie,8,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                                                fprintf(file6,['						               .clk(clk),','\n']);
                                                fprintf(file6,['											.rst(rst),','\n']);
                                                fprintf(file6,['											.rst_user(rst_user),','\n']);
                                                fprintf(file6,['											.before_enaread(sta_sig[',num2str(ZONE2{ilie,1,lei}-4),']),\n']);
                                                fprintf(file6,['											.before_enawrite(sta_sig[',num2str(ZONE2{i,1,str2double(HISTORYLEI{hist,1})} + DD(str2double(HISTORYLEI{hist,1})) - 2+40),']),\n']);
                                                fprintf(file6,['								.cin( ','',LEIXING(str2double(HISTORYLEI{hist,1}),:),'_',num2str(yushu),'_result_40',' ),\n']);
                                                fprintf(file6,['								.cout( ','',ZONE2{ilie,8,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' )\n']);
                                                fprintf(file6,['					                 );','\n']);
                                         else
                                             fprintf(file6,['wire [`EXTENDED_SINGLE - 1:0] ',ZONE2{ilie,8,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),';\n']);
                                            fprintf(file6,['System_FIFO_64_1	FIFO_',ZONE2{ilie,8,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),' (\n']);
                 ...
                 fprintf(file8,['					              .x(',ZONE2{ilie,8,lei},'_lyf',num2str(ZONE1{jj,1,ilie,lei}),'),','\n']);
             end
            ...
            fprintf(file8,['					              .y','(limit_',num2str(ZONE2{ilie,2,lei}),'_lyf',')','\n']);
            fprintf(file8,['							   );','\n']);
        end
    end
end
