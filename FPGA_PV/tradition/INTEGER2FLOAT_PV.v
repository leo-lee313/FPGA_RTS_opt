...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=10 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=10 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=10 WIDTHDIST=4 aclr clk_en clock data distance result
...
module  INTEGER2FLOAT_PV_altbarrel_shift_lsf
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[9:0]	sbit_piper1d;
	reg	[9:0]	sbit_piper2d;
	reg	sel_pipec2r1d;
	reg	sel_pipec3r1d;
	wire  [4:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 10'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[19:10];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 10'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[39:30];
	// synopsys translate_off
	initial
		sel_pipec2r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		pad_w = {8{1'b0}},
		result = sbit_w[49:40],
		sbit_w = {sbit_piper2d, smux_w[29:20], sbit_piper1d, smux_w[9:0], data},
		sel_w = {sel_pipec3r1d, sel_pipec2r1d, distance[1:0]},
		smux_w = {((({10{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[31:30], pad_w[7:0]}) | ({10{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[39:38]})) | ({10{(~ sel_w[3])}} & sbit_w[39:30])), ((({10{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[25:20], pad_w[3:0]}) | ({10{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[29:24]})) | ({10{(~ sel_w[2])}} & sbit_w[29:20])), ((({10{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[17:10], pad_w[1:0]}) | ({10{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[19:12]})) | ({10{(~ sel_w[1])}} & sbit_w[19:10])), ((({10{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[8:0], pad_w[0]}) | ({10{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[9:1]})) | ({10{(~ sel_w[0])}} & sbit_w[9:0]))};
endmodule //INTEGER2FLOAT_PV_altbarrel_shift_lsf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTEGER2FLOAT_PV_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //INTEGER2FLOAT_PV_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTEGER2FLOAT_PV_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //INTEGER2FLOAT_PV_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTEGER2FLOAT_PV_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	INTEGER2FLOAT_PV_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	INTEGER2FLOAT_PV_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //INTEGER2FLOAT_PV_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTEGER2FLOAT_PV_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	INTEGER2FLOAT_PV_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	INTEGER2FLOAT_PV_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //INTEGER2FLOAT_PV_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTEGER2FLOAT_PV_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	INTEGER2FLOAT_PV_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	INTEGER2FLOAT_PV_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
endmodule //INTEGER2FLOAT_PV_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTEGER2FLOAT_PV_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	INTEGER2FLOAT_PV_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	INTEGER2FLOAT_PV_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //INTEGER2FLOAT_PV_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTEGER2FLOAT_PV_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	INTEGER2FLOAT_PV_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	INTEGER2FLOAT_PV_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
endmodule //INTEGER2FLOAT_PV_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 131 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTEGER2FLOAT_PV_altfp_convert_o0o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	wire  [9:0]   wire_altbarrel_shift5_result;
	...
	reg	[8:0]	mag_int_a_reg;
	reg	[8:0]	mag_int_a_reg2;
	...
	wire  [9:0]  prio_mag_int_a;
	wire  [5:0]  priority_pad_one_w;
	wire  [31:0]  result_w;
	wire  [8:0]  shifted_mag_int_a;
	wire  sign_bus;
	wire  sign_int_a;
	wire  [3:0]  zero_padding_w;

	INTEGER2FLOAT_PV_altbarrel_shift_lsf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	INTEGER2FLOAT_PV_altpriority_encoder_rb6   altpriority_encoder2
	( 
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg <= 9'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg2 <= 9'b0;
	...
	assign
		...
		mag_int_a = (({9{(~ sign_int_a)}} & int_a) | ({9{sign_int_a}} & int_a_2s)),
		mantissa_bus = mantissa_rounded[22:0],
		mantissa_pre_round = {shifted_mag_int_a[8:0], {15{1'b0}}},
		...
		priority_pad_one_w = {6{1'b1}},
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		shifted_mag_int_a = wire_altbarrel_shift5_result[8:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[9],
		zero_padding_w = {4{1'b0}};
endmodule //INTEGER2FLOAT_PV_altfp_convert_o0o
//VALID FILE
...
module INTEGER2FLOAT_PV (
	...
	INTEGER2FLOAT_PV_altfp_convert_o0o	INTEGER2FLOAT_PV_altfp_convert_o0o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
