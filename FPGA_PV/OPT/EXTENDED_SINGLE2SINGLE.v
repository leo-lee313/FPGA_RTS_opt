...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix V" OPERATION="FLOAT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
module  EXTENDED_SINGLE2SINGLE_altfp_convert_j5o
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //EXTENDED_SINGLE2SINGLE_altfp_convert_j5o
//VALID FILE
...
module EXTENDED_SINGLE2SINGLE (
	...
	EXTENDED_SINGLE2SINGLE_altfp_convert_j5o	EXTENDED_SINGLE2SINGLE_altfp_convert_j5o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
