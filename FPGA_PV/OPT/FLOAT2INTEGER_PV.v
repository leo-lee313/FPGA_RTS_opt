...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=10 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=10 aclr clk_en clock dataa result
...
module  FLOAT2INTEGER_PV_altbarrel_shift_qsf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FLOAT2INTEGER_PV_altbarrel_shift_qsf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 189 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FLOAT2INTEGER_PV_altfp_convert_o0o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	wire  [31:0]   wire_altbarrel_shift6_result;
	...
	reg	int_or_reg2;
	reg	int_or_reg3;
	reg	[9:0]	integer_result_reg;
	reg	[8:0]	integer_rounded_reg;
	...
	wire  add_1_cout_w;
	wire  add_1_w;
	wire  [9:0]  all_zeroes_w;
	wire  [31:0]  barrel_mantissa_input;
	wire  [7:0]  barrel_zero_padding_w;
	wire  below_limit_exceeders;
	wire  [9:0]  below_limit_integer;
	...
	wire  [9:0]  infinity_value_w;
	wire  int_or1_w;
	wire  [9:0]  integer_output;
	wire  [8:0]  integer_post_round;
	wire  [8:0]  integer_pre_round;
	wire  [9:0]  integer_result;
	wire  [8:0]  integer_rounded;
	wire  [8:0]  integer_rounded_tmp;
	wire  [8:0]  integer_tmp_output;
	wire  [3:0]  inv_add_1_adder1_w;
	wire  [4:0]  inv_add_1_adder2_w;
	wire  [8:0]  inv_integer;
	wire  [31:0]  lbarrel_shift_result_w;
	wire  [8:0]  lbarrel_shift_w;
	wire  lower_limit_selector;
	wire  lowest_integer_selector;
	wire  [8:0]  lowest_integer_value;
	wire  [10:0]  man_bus1;
	wire  [11:0]  man_bus2;
	wire  [10:0]  man_or1;
	wire  man_or1_w;
	...
	wire  sign_input;
	wire  sign_input_w;
	wire  [8:0]  signed_integer;
	wire  sticky_bit_w;
	wire  [21:0]  sticky_bus;
	wire  [21:0]  sticky_or;
	wire  [8:0]  unsigned_integer;
	wire  upper_limit_w;
	wire  zero_input_w;

	FLOAT2INTEGER_PV_altbarrel_shift_qsf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) integer_result_reg <= 10'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) integer_rounded_reg <= 9'b0;
	...
	assign
		...
		exceed_limit_integer = (({10{(~ exceed_limit_exceeders)}} & below_limit_integer) | ({10{exceed_limit_exceeders}} & infinity_value_w)),
		...
		infinity_value_w = (({10{(~ sign_input_w)}} & pos_infi_w) | ({10{sign_input_w}} & neg_infi_w)),
		int_or1_w = man_or2[3],
		...
		integer_rounded = (({9{(~ lowest_integer_selector)}} & integer_rounded_tmp) | ({9{lowest_integer_selector}} & lowest_integer_value)),
		integer_rounded_tmp = (({9{(~ add_1_w)}} & integer_pre_round) | ({9{add_1_w}} & integer_post_round)),
		integer_tmp_output = (({9{(~ sign_input_w)}} & unsigned_integer) | ({9{sign_input_w}} & signed_integer)),
		inv_add_1_adder1_w = wire_add_sub8_result,
		inv_add_1_adder2_w = (({5{(~ wire_add_sub8_cout)}} & inv_integer[8:4]) | ({5{wire_add_sub8_cout}} & wire_add_sub9_result)),
		inv_integer = (~ integer_rounded_reg),
		lbarrel_shift_result_w = wire_altbarrel_shift6_result,
		lbarrel_shift_w = lbarrel_shift_result_w[31:23],
...
endmodule //FLOAT2INTEGER_PV_altfp_convert_o0o
//VALID FILE
...
module FLOAT2INTEGER_PV (
	...
	FLOAT2INTEGER_PV_altfp_convert_o0o	FLOAT2INTEGER_PV_altfp_convert_o0o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
