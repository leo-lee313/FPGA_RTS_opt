...
//lpm_mux DEVICE_FAMILY="Stratix V" LPM_PIPELINE=1 LPM_SIZE=8 LPM_WIDTH=64 LPM_WIDTHS=3 clock data result sel
...
module muxer7 (
	...
	muxer7_mux	muxer7_mux_component (
				.clock (clock),
				.data (sub_wire2),
				.sel (sel),
				.result (sub_wire0));
