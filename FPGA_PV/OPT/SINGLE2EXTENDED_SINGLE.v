...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix V" OPERATION="FLOAT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 aclr clk_en clock dataa result
...
module  SINGLE2EXTENDED_SINGLE_altfp_convert_j5o
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //SINGLE2EXTENDED_SINGLE_altfp_convert_j5o
//VALID FILE
...
module SINGLE2EXTENDED_SINGLE (
	...
	SINGLE2EXTENDED_SINGLE_altfp_convert_j5o	SINGLE2EXTENDED_SINGLE_altfp_convert_j5o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
